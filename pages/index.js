...
const Home = () => {
  ...
  const generateAction = async () => {
    ...
    const finalInput = input.replace("Ashton", "aHenryDukes")
      ...
      <div className="container">
        <div className="header">
          <div className="header-title">
            <h1>An Ashton Henry Image Generator</h1>
          </div>
          <div className="header-subtitle">
            <h2>Generate images of Ashton with text below! Make sure to use the capitalized reference "Ashton" in the prompt</h2>
          </div>
